...
require 'internet_scrabble_club/entities'

Celluloid.logger.level = Logger::INFO

MongoMapper.connection = Mongo::Connection.new('localhost', 27017)
MongoMapper.database = 'internet-scrabble-club'
...
if ARGV.length < 2
  fail "Please provide nickname/password: bin/scraper <nickname> <password>"
end

Scraper.new(ARGV[0], ARGV[1])
